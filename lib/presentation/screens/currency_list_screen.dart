...
class CurrencyListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<CurrencyListBloc>(
      future: getIt.getAsync<CurrencyListBloc>(),
      builder: (context, snapshot) {
        ...
        return BlocProvider(
          create: (context) => snapshot.data!..add(const LoadCurrencies()),
          child: Scaffold(
            appBar: AppBar(
